...
<svelte:head>
  ...
  <link
    href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;700&family=Poppins:wght@600;800;900&display=swap"
    rel="stylesheet"
  />
  <style>
  ...
  <main>
    <section class="hero-bg text-white py-20 md:py-32 overflow-hidden">
      <div class="container mx-auto px-6 text-center animated-section">
        ...
        <p class="text-lg md:text-xl max-w-3xl mx-auto mb-8 text-blue-100/80">
          A club for students who love to code, create, and launch their ideas.
          Welcome to the first Hack Club in Tbilisi, where you learn to code by
    ...
    <section id="about" class="py-16 md:py-24 bg-[#f8f9fa] text-gray-800">
      ...
      >
        <div class="max-w-4xl mx-auto text-center">
          <h3 class="text-3xl md:text-4xl font-extrabold mb-8 font-heading">
            This is your club.
          </h3>
          <p class="text-lg text-gray-600 leading-relaxed">
            Tbilisi Hack Club is a community of young makers, coders, and
            creators. Our philosophy is simple: the best way to learn is by
            doing. We provide the space, community, and support. You bring your
            curiosity and ideas. No experience required.
          </p>
        </div>
      </div>
    </section>
      ...
      >
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="event-card">
            ...
            <h4 class="text-xl font-bold text-gray-800 mb-2">Workshops</h4>
            <p class="text-gray-600">
              Dive into new technologies with hands-on, project-based workshops,
              from web dev to AI.
            </p>
          </div>
          <div class="event-card">
            ...
            <h4 class="text-xl font-bold text-gray-800 mb-2">Club Meetings</h4>
            <p class="text-gray-600">
              Share what you're working on, get help from peers, and find
          ...
          <div class="event-card">
            ...
            <h4 class="text-xl font-bold text-gray-800 mb-2">Hackathons</h4>
            <p class="text-gray-600">
              Join high-energy coding events to build amazing projects in a
              single weekend.
            </p>
          </div>
        </div>
...
<style>
  ...
  .cta-button {
    @apply inline-block bg-white text-blue-700 font-bold py-3 px-8 rounded-lg shadow-lg transform transition-all duration-300;
  }
  .cta-button:hover {
  ...
  .event-card {
    @apply bg-white rounded-xl shadow-lg p-6 text-center transition-all duration-300;
  ...
  .icon-wrapper {
    @apply p-4 rounded-full mb-4 inline-flex;
  }

  .sponsor-link {
    @apply flex flex-col items-center text-gray-700 transition-transform duration-300;
  }
