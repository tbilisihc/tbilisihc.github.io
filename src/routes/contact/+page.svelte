  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (webhookResponse.ok) {
        feedbackMessage = "Thank you! Your message has been sent successfully.";
        ...
        try {
          const emailData = {
            recipient: email,
            subject: "Regarding your message to Tbilisi Hack Club",
            message: `Thank you for leaving a message!\n\nWe will get back to you soon.\n\nWhile you wait, you can check out our social media accounts:\nhttps://www.youtube.com/@tbilisihc\n\nHave a great day!\nBest regards,\nTbilisi Hack Club Administration`,
          };
        ...
        feedbackMessage = `An error occurred: ${webhookResponse.status}. Please try again.`;
        feedbackType = "error";
...
<svelte:head>
  ...
  <title>Contact Us - Tbilisi Hack Club</title>
</svelte:head>
    ...
    <div class="max-w-5xl mx-auto">
      ...
      >
        <div class="flex flex-col">
          ...
          <form on:submit|preventDefault={handleSubmit} class="space-y-6">
            ...
            <div>
              <label
                for="subject"
                class="block text-sm font-medium text-slate-700">Subject</label
              >
              <div class="mt-1">
                <input
                  bind:value={subject}
            ...
            <div>
              <label
                for="message"
                class="block text-sm font-medium text-slate-700">Message</label
              >
              <div class="mt-1">
                <textarea
                  bind:value={message}
        ...
        <div class="flex flex-col space-y-8">
          ...
          <div>
            <h3 class="text-2xl font-bold text-slate-900 mb-4">Or here:</h3>
