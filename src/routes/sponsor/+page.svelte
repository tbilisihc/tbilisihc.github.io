    ...
    <div class="content-scroller">
        ...
        <div class="benefits-grid">
          ...
          <div class="benefit-card">
            ...
            <p class="benefit-text">
              Our team works every day and night, while keeping nothing for
              ourselves.
            </p>
          </div>
          <!-- Benefit 2 -->
          <div class="benefit-card">
            ...
            <h3 class="benefit-title">Functioning of the club is expensive</h3>
            <p class="benefit-text">
              Our club costs a lot of money to operate, which comes out of our
              pocket.
            </p>
          </div>
          <!-- Benefit 3 -->
          <div class="benefit-card">
            ...
            <p class="benefit-text">
              Invest in the local tech education and help foster innovation and
              collaboration.
            </p>
          </div>
        </div>
      ...
      <section id="contact">
        ...
        <p class="contact-subtitle">
          We'd love to partner with you. For custom packages or any questions,
          please reach out to our sponsorship team.
        </p>
        <div class="contact-actions">
          <a href="mailto:tbilisihc@yahoo.com" class="cta-button">Sponsor Us</a>
