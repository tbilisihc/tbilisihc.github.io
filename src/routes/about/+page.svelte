...
<main class="page-wrapper">
  ...
  <section id="events" class="py-16 md:py-24 bg-white">
    ...
    >
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
        ...
        <div
          class="bg-blue-500 text-white flex flex-col justify-center items-center rounded-xl shadow-lg p-6 text-center transition-all duration-300 rounded-xl shadow-lg p-6 md:p-8 transition-transform duration-300 hover:-translate-y-2 shadow-xl"
        >
  ...
  <section id="join" class="hero-bg">
    ...
    >
      ...
      <a href="/join" class="cta-button">{$_("about_page.join.cta_button")}</a>
    </div>
  </section>
</main>
...
<style>
  ...
  .info-card {
    @apply bg-white rounded-xl shadow-lg p-6 text-center transition-all duration-300 rounded-xl shadow-lg p-6 md:p-8 transition-transform duration-300 hover:-translate-y-2;
