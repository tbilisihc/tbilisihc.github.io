...
<main class="page-wrapper">
  ...
  <section class="hero-bg text-white py-20 md:py-32 overflow-hidden">
    <div class="container mx-auto px-6 text-center animated-section">
      ...
      <p class="text-lg md:text-xl max-w-3xl mx-auto mb-8 text-blue-100/90">
        In a city buzzing with ancient history and a vibrant, emerging tech
        scene, a new chapter is unfolding. Welcome to a space for young
        creators, coders, and innovators to come together, learn, and build
        amazing things.
      </p>
  ...
  <section id="join" class="hero-bg">
    ...
    >
      ...
      <a href="mailto:tbilisihc@yahoo.com" class="cta-button">Learn More</a>
    </div>
  </section>
</main>
