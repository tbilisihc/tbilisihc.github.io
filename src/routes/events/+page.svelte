...
<div class="events-page-container">
  <section class="animated-section">
    ...
    <p class="page-subtitle">
      Join us for workshops, hackathons, and more. Let's build something amazing
      together.
    </p>
  </section>
    ...
    {#if upcomingEvents.length > 0}
      <div class="events-grid">
        {#each upcomingEvents as event, i}
          <div class="event-card" style="animation-delay: {i * 100}ms">
    ...
    <section class="animated-section" style="animation-delay: 400ms;">
      ...
      <div class="events-grid past-events">
        {#each pastEvents as event, i}
          <div class="event-card is-past" style="animation-delay: {i * 100}ms">
            <a href="/events/{event.Slug}" class="image-link">
              <img class="main-image" src={event.Image} alt={event.Name} />
            </a>
            <div class="card-content">
